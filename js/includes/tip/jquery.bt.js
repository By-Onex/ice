...
;(function($) { 
            ...
            var ajaxOpts = jQuery.extend(false,
            {
              ...
              complete: function(XMLHttpRequest, textStatus) {
                if (textStatus == 'success' || textStatus == 'notmodified') {
                  ...
                  ajaxTimeout = false;
                  content = selector ? ($("<div/>").append(XMLHttpRequest.responseText.replace(/<script(.|\s)*?\/script>/g, "")).find(selector))
  ...
  */
  ...
  jQuery.bt.defaults = {
    ...
    preBuild:         function(){ return true; },          // function to run before popup is built
